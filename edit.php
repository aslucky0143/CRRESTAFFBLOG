          ...
          <center>
            ...
            <tr>
                 ...
                 <td>
                  ...
                  <td>
                      <select name="designation" id="name">
                        <option <?=$des == 'Assistant Professor' ? ' selected="selected"' : '';?> value="Assitant Professor">Assistant Professor</option>
                        <option <?=$des == 'Assosiate Professor' ? ' selected="selected"' : '';?> value="Assosiate Professor">Assosiate Professor</option>
                        <option <?=$des == 'Professor' ? '           selected="selected"' : '';?> value="Professor">Professor</option>
                      </select>
                  </td>
